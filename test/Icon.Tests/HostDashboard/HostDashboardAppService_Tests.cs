...
using Icon.MultiTenancy.HostDashboard;
...
namespace Icon.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(IconDbContext context, SubscriptionPayment subscriptionPayment)
        {
