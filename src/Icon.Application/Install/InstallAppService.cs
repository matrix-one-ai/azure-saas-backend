...
using Icon.Migrations.Seed;
using Icon.Migrations.Seed.Host;
...
namespace Icon.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : IconAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<IconDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{IconConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{IconConsts.ConnectionStringName}", constring);
        }
