...
using Icon.Authentication.PasswordlessLogin;
using Icon.Authorization.PasswordlessLogin;

namespace Icon.Authorization.Accounts
{
    public class AccountAppService : IconAppServiceBase, IAccountAppService
    {
        ...
        private async Task SendSmsPasswordlessCode(string phoneNumber)
        {
            ...
            var message = string.Format(L("PasswordlessLogin_SmsMessage", IconConsts.ProductName, code));
