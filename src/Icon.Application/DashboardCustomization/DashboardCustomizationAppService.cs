...
using Icon.DashboardCustomization.Dto;

namespace Icon.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : IconAppServiceBase, IDashboardCustomizationAppService
    {
