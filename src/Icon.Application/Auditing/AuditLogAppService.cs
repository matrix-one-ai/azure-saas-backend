...
using Icon.Auditing.Exporting;
using Icon.Authorization;
using Icon.Authorization.Users;
using Icon.Dto;
using Icon.EntityChanges.Dto;
using Icon.EntityHistory;
using System.Collections.Generic;
using System.Linq;
using System.Linq.Dynamic.Core;
using System.Threading.Tasks;
using EntityHistoryHelper = Icon.EntityHistory.EntityHistoryHelper;

namespace Icon.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : IconAppServiceBase, IAuditLogAppService
    {
