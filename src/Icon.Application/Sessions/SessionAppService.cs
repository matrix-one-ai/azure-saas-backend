...
{
    public class SessionAppService : IconAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = IconConsts.Currency,
                        CurrencySign = IconConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = IconConsts.AllowTenantsToChangeEmailSettings,
