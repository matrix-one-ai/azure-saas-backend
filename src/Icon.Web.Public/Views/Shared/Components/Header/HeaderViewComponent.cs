...
using Icon.Url;
using Icon.Web.Public.Startup;
using Icon.Web.Session;
using Icon.Web.UiCustomization;

namespace Icon.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : IconViewComponent
    {
