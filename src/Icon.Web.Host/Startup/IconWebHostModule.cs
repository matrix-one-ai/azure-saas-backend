...
namespace Icon.Web.Startup
{
    ...
    public class IconWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public IconWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IconWebHostModule).GetAssembly());
        }
