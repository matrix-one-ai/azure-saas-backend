...
using Icon.Authorization.Ldap;
using Icon.Authorization.Roles;
using Icon.Authorization.Users;
using Icon.Chat;
using Icon.Configuration;
using Icon.DashboardCustomization.Definitions;
using Icon.Debugging;
using Icon.DynamicEntityProperties;
using Icon.Features;
using Icon.Friendships;
using Icon.Friendships.Cache;
using Icon.Localization;
using Icon.MultiTenancy;
using Icon.Net.Emailing;
using Icon.Notifications;
using Icon.WebHooks;

namespace Icon
{
    [DependsOn(
        typeof(IconCoreSharedModule),
    ...
    public class IconCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            IconLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = IconConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, IconMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<IconSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IconCoreModule).GetAssembly());
        }
