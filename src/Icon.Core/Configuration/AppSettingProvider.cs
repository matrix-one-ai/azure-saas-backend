...
using Icon.DashboardCustomization;
...
namespace Icon.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!IconConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        IconConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        IconDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        IconDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = IconDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{IconDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{IconDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = IconDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = IconDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    IconDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = IconDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{IconDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{IconDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = IconDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = IconDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    IconDashboardCustomizationConsts.Widgets.Tenant
