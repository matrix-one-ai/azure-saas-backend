...
{
    public class IconMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public IconMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(IconConsts.LocalizationSourceName, name);
        }
