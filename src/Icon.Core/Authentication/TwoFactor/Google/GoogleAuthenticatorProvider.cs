...
namespace Icon.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : IconServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Icon", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
