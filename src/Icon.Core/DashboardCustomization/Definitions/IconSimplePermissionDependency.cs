...
/// </summary>
public class IconSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public IconSimplePermissionDependency()
    {
    ...
    public IconSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public IconSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
