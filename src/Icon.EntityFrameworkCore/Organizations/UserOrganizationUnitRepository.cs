...
using Icon.EntityFrameworkCore.Repositories;

namespace Icon.Organizations
{
    public class UserOrganizationUnitRepository : IconRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<IconDbContext> dbContextProvider)
