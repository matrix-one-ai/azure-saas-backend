...
namespace Icon.Migrations
{
    ...
    [Migration("20241215125058_AddedMemStartAsDbSet")]
    partial class AddedMemStartAsDbSet
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Icon.Matrix.Memory", b =>
                {
                    ...
                    b.Property<Guid?>("MemoryStatsTwitterId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MemoryStatsTwitterId");
            ...
            modelBuilder.Entity("Icon.Matrix.Memory", b =>
                {
                    ...
                    b.HasOne("Icon.Matrix.MemoryStatsTwitter", "MemoryStatsTwitter")
                        .WithMany()
                        .HasForeignKey("MemoryStatsTwitterId")
                        .OnDelete(DeleteBehavior.Cascade);
