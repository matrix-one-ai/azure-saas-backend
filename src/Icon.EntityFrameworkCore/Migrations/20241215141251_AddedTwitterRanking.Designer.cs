...
namespace Icon.Migrations
{
    ...
    [Migration("20241215141251_AddedTwitterRanking")]
    partial class AddedTwitterRanking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Icon.Matrix.Character", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterBio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterPersona", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterPersonaTwitterRank", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterPlatform", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterTopic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.Memory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.MemoryStatsTwitter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.MemoryTopic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.MemoryType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.Persona", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.PersonaPlatform", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.Platform", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.Topic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterBio", b =>
                {
                    b.HasOne("Icon.Matrix.Character", "Character")
                        .WithMany()
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Icon.Matrix.Character", null)
                        .WithMany("Bios")
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterPersona", b =>
                {
                    ...
                    b.HasOne("Icon.Matrix.Persona", "Persona")
                        .WithMany()
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterPersonaTwitterRank", b =>
                {
                    b.HasOne("Icon.Matrix.CharacterPersona", "CharacterPersona")
                        .WithMany()
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterPlatform", b =>
                {
                    ...
                    b.HasOne("Icon.Matrix.Platform", "Platform")
                        .WithMany()
            ...
            modelBuilder.Entity("Icon.Matrix.CharacterTopic", b =>
                {
                    ...
                    b.HasOne("Icon.Matrix.Topic", "Topic")
                        .WithMany()
            ...
            modelBuilder.Entity("Icon.Matrix.Memory", b =>
                {
                    b.HasOne("Icon.Matrix.CharacterBio", "CharacterBio")
                        .WithMany()
                    ...
                    b.HasOne("Icon.Matrix.MemoryType", "MemoryType")
                        .WithMany()
            ...
            modelBuilder.Entity("Icon.Matrix.MemoryStatsTwitter", b =>
                {
                    b.HasOne("Icon.Matrix.Memory", "Memory")
                        .WithOne("MemoryStatsTwitter")
                        .HasForeignKey("Icon.Matrix.MemoryStatsTwitter", "MemoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
