...
namespace Icon.Migrations
{
    ...
    [Migration("20250128145536_AddedDummyBuySell")]
    partial class AddedDummyBuySell
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Icon.Matrix.Models.Character", b =>
                {
                    ...
                    b.Property<int>("TwitterAutoPostDelayMinutes")
                        .HasColumnType("int");

                    b.Property<string>("TwitterAutoPostExamples")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TwitterAutoPostInstruction")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("TwitterCommType")
                        .HasColumnType("int");

                    b.Property<string>("TwitterMentionReplyExamples")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TwitterMentionReplyInstruction")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Icon.Matrix.Models.CharacterPersona", b =>
                {
                    ...
                    b.Property<bool>("TwitterBlockInRanking")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Icon.Matrix.Models.CharacterPersonaTwitterProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Icon.Matrix.Models.CharacterPersonaTwitterRank", b =>
                {
                    ...
                    b.Property<int>("TotalDepthScore")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TotalMentionsScore")
                        .HasColumnType("int");

                    b.Property<int>("TotalNoveltyScore")
                        .HasColumnType("int");

                    b.Property<int>("TotalQualityScore")
                        .HasColumnType("int");

                    b.Property<int>("TotalRelevanceScore")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TotalScoreTimeDecayed")
                        .HasColumnType("int");

                    b.Property<int>("TotalSentimentScore")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Icon.Matrix.Models.RaydiumPair", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AmmAccount")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BaseTokenAccount")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("BaseTokenDecimals")
                        .HasColumnType("int");

                    b.Property<string>("BaseTokenLiquidityAdded")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BaseTokenLogo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BaseTokenName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BaseTokenSupply")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BaseTokenSymbol")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<float>("DummyBuyAmount")
                        .HasColumnType("real");

                    b.Property<float>("DummyBuyPrice")
                        .HasColumnType("real");

                    b.Property<float>("DummyBuyQuantity")
                        .HasColumnType("real");

                    b.Property<DateTimeOffset?>("DummyBuyTime")
                        .HasColumnType("datetimeoffset");

                    b.Property<float>("DummySellAmount")
                        .HasColumnType("real");

                    b.Property<float>("DummySellPrice")
                        .HasColumnType("real");

                    b.Property<float>("DummySellQuantity")
                        .HasColumnType("real");

                    b.Property<DateTimeOffset?>("DummySellTime")
                        .HasColumnType("datetimeoffset");

                    b.Property<bool>("EngagementBuyRecommendation")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTimeOffset?>("EngagementRecommendedSellByTime")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<string>("QuoteTokenLiquidityAdded")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TokenHolderData")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("TweetsCAEngagementUniqueAuthors")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Icon.Matrix.Models.TwitterImportLog", b =>
                {
                    ...
                    b.Property<string>("TwitterAgentId")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("TwitterImportLogs");
                });

            modelBuilder.Entity("Icon.Matrix.Models.TwitterImportTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("ImportLimitTotal")
                        .HasColumnType("int");

                    b.Property<bool>("IsEnabled")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("LastRunCompletionTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("RunEveryXMinutes")
                        .HasColumnType("int");
                    ...
                    b.ToTable("TwitterImportTasks");
                });

            modelBuilder.Entity("Icon.Matrix.Models.TwitterImportTweet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InReplyToStatusJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsSelfThread")
                        .HasColumnType("bit");

                    b.Property<DateTime>("LastTwitterImportDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("LastTwitterImportExported")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("QuotedStatusJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Replies")
                        .HasColumnType("int");

                    b.Property<string>("RetweetedStatusId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RetweetedStatusJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime>("TimeParsed")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Icon.Matrix.Models.CharacterPersonaTwitterProfile", b =>
                {
                    b.HasOne("Icon.Matrix.Models.CharacterPersona", null)
                        .WithOne("TwitterProfile")
                        .HasForeignKey("Icon.Matrix.Models.CharacterPersonaTwitterProfile", "CharacterPersonaId");
                });
