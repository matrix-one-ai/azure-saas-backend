...
using Icon.Core.Base;
using Icon.Core.Extensions;
using Icon.Dto;
using Icon.Types;

namespace Icon.Queries
{
    public class OrganizationUnitQuery : IconQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
