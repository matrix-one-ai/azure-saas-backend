...
using Icon.Authentication.TwoFactor;
using Icon.Chat;
using Icon.Configuration;
using Icon.EntityFrameworkCore;
using Icon.Startup;
using Icon.Web.Authentication.JwtBearer;
using Icon.Web.Authentication.TwoFactor;
using Icon.Web.Chat.SignalR;
using Icon.Web.Common;
using Icon.Web.Configuration;
using Icon.Web.DashboardCustomization;
...
{
    [DependsOn(
        typeof(IconApplicationModule),
        typeof(IconEntityFrameworkCoreModule),
    ...
    public class IconWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public IconWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = _appConfiguration.GetConnectionString(
                IconConsts.ConnectionStringName
            );
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(IconApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(IconWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(IconWebCoreModule).Assembly);
        }
