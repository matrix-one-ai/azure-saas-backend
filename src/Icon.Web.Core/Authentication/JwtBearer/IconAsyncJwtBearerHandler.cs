...
namespace Icon.Web.Authentication.JwtBearer
{
    public class IconAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public IconAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
