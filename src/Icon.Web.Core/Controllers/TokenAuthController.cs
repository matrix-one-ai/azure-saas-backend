...
using Icon.Authentication.TwoFactor.Google;
...
using Icon.Web.Models.TokenAuth;
using Icon.Authorization.Impersonation;
using Icon.Authorization.Roles;
using Icon.Configuration;
using Icon.Identity;
using Icon.Net.Sms;
using Icon.Notifications;
using Icon.Security.Recaptcha;
using Icon.Web.Authentication.External;
using Icon.Web.Common;
using Icon.Authorization.Delegation;
using Abp.Runtime.Validation;
using Icon.Authorization.PasswordlessLogin;

namespace Icon.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : IconControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(IconConsts.DateTimeOffsetFormat));
